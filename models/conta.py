...
class Conta:
    ...
    @saldo.setter
    def saldo(self: object, valor: float) -> None:  # Retorno do setter é sempre None
        self.__saldo = valor
    ...
    # Definir operação para depositar
    ...
    # Definir operação para transferir
